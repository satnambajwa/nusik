...
<html lang="en">
  <head>
    <meta charset="utf-8">
    <title>Nusik:A new way to discover Musik</title>
	...
	<?php  
	 ...
	 // $cs->registerScriptFile($baseUrl.'js/mason.min.js');
	  $cs->registerScriptFile($baseUrl.'/js/nusik-oth.js');
...
<?php if($this->action->Id!='index')require_once('tpl_navigation.php')?>
</section><!-- /#navigation-main -->
    
<section class="main-body">
 <?php if($this->action->Id=='index')
 		{
   			echo '<div class="container-fluid" id="cont">';
            
			echo $content; 
	 	}
	 else
	 {
		  echo '<div class="container-fluid1" id="cont">';
...
<!-- Require the footer -->
<?php if($this->action->Id!='index')require_once('tpl_footer.php')?>
