...
<img src="<?php echo (file_exists(Yii::app()->baseUrl.'/images/'.$model->cover_photo))? Yii::app()->baseUrl.'/images/'.$model->cover_photo: $baseUrl.'/img/Cover_placeholder.jpg';?>" class=" mgtop-20 img-polaroids"/>	
</div>
			...
			<section class="row-fluid">
				...
				<!-- Sidebar with biography-->
					...
					<span>
						...
						<img src="<?php echo (file_exists(ImageFly::Instance()->get($model, 'image', 600, 745)))? ImageFly::Instance()->get($model, 'image', 600, 745): $baseUrl.'/img/profile-placeholder.jpg';?>" class="img-polaroid span12" />
										...
										<!-- List of Recent Updates-->
											<article class="tab-pane table-overflow" id="tab-recent"> 
											 ...
											 ?>
												<div class="row-fluid">		
													<span class="span2 thumbnail">
														<img src="<?php echo (file_exists(ImageFly::Instance()->get($usersInfo, 'image', 150, 150)))? ImageFly::Instance()->get($usersInfo, 'image', 150, 150): $baseUrl.'/img/profile-placeholder.jpg';?>" />
										...
										<!--List of Comments-->
											<article class="tab-pane table-overflow" id="tab-comment"> 
											 ...
											 ?>
												<div class="row-fluid">		
													<span class="span2 thumbnail">
														<img src="<?php echo (file_exists(ImageFly::Instance()->get($comment->profile, 'image', 150, 150)))? ImageFly::Instance()->get($comment->profile, 'image', 150, 150): $baseUrl.'/img/profile-placeholder.jpg';?>" />
					...
					<!-- List of Likes-->	
							<span class="span12 thumbnails">
								...
								//CVarDumper::dump(,10,1);die;?><?php  if(count($following)>='5')
									...
									?>
									<span class="span2 thumbnail">
										<a href="<?php echo ($follows->artistsProfile->profile->users->roles->roles_name=='Artist')?$this->createUrl('site/ajaxprofile',array('id'=>$follows->artistsProfile->profile->users_id)):$this->createUrl('site/ajaxlistener',array('id'=>$follows->artistsProfile->profile->users_id));?>" class="navlink"><img src="<?php echo (file_exists(ImageFly::Instance()->get($follows->artistsProfile->profile)))?ImageFly::Instance()->get($follows->artistsProfile->profile, 'image', 150, 150):$baseUrl.'/img/profile-placeholder.jpg';?>" />
						...
						<!-- List of Following-->	
							<span class="span12 thumbnails">
								...
								//CVarDumper::dump(,10,1);die;?><?php  if(count($following)>='5')
									...
									?>
									<span class="span2 thumbnail">
										<a href="<?php echo ($follows->artistsProfile->profile->users->roles->roles_name=='Artist')?$this->createUrl('site/ajaxprofile',array('id'=>$follows->artistsProfile->profile->users_id)):$this->createUrl('site/ajaxlistener',array('id'=>$follows->artistsProfile->profile->users_id));?>" class="navlink"><img src="<?php echo (file_exists(ImageFly::Instance()->get($follows->artistsProfile->profile, 'image', 150, 150)))?ImageFly::Instance()->get($follows->artistsProfile->profile, 'image', 150, 150):$baseUrl.'/img/profile-placeholder.jpg';?>" />
											<p align="center"><?php echo $follows->artistsProfile->profile->users->display_name;?></p></a>
									</span>
									<?php }
										}
