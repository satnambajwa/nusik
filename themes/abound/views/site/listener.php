		...
		<div class="tab-content">
			...
			<div style="width:100%" class="tab-pane" id="playlist" >
			  <table width="100%"><tr><td width="50%" align="center" valign="top">
			   ...
			   ?>
			  <table width="90%">
			  <tr bgcolor="#333333"><td width="100%" align="center"><h4 class="color-white" align="center">Playlist's Name</h4></td> </tr>
			  <?php $flag=1;
			  foreach($playlist as $pl)
			  {
			  ?>
			  
			  <tr bgcolor="<?php if($flag==1){echo '#CCCCCC';$flag=0;} else{'#FFFFFF'; $flag=1;}?>"><td width="100%" align="center">
			  
			  <h5><img src="<?php echo $baseUrl; ?>/img/plist.png" class="mgright5" width="35px" /> <a href="javascript:void(0)" onclick="tracklist(<?php echo $pl->id ?>);"><?php echo $pl->playlist_name; ?></a>
			  </h5></td><tr>
			  <?php
			  }
			  ?>
			...
			<div id="list" style="width:100%; display: inline-block;margin-top:0px;">
			</div>
			</td></tr>
			</table>
			 </div>
			 <div id="following"  class="tab-pane row-fluid">
