...
class ArtistTrackController extends Controller
{
	...
	{
		$dataProvider=new CActiveDataProvider('ArtistTrack');
	 ...
	 * @return ArtistTrack the loaded model
	 ...
	 * @param ArtistTrack $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='artist-track-form')
		{
