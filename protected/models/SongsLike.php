...
/**
 * This is the model class for table "songs_like".
 *
 * The followings are the available columns in table 'songs_like':
 * @property integer $id
 ...
 */
class SongsLike extends CActiveRecord
{
	/**
	 ...
	 * @return SongsLike the static model class
	 */
